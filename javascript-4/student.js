...
const faveColors = ['#fc7f03', 'black', 'white']
...
const me = {
  firstName: 'Chaz',
  superHeroName: 'That Guy',
  homeTown: 'St. George',
  superPowers: ['being average', 'adulting', 'parenting'],
...
function setColor(arr) {
  const colorArr = arr.splice(0,3)
  for (var i = 0; i < 3; i++) {
    if (colorArr[i] === 'blue') {
      colorArr[i] = '#4D4DFF'
    }
  }
  background(colorArr[0], colorArr[1], colorArr[2])
}
